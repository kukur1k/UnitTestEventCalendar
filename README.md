...
- Параметры:
  - `participants`: список участников
## Помимо методов, возрвращающих списки событий, в библиотеке присутствуют методы `Show...`, аналогичные по сигнатуре методам `Get...` для вывода данных о событиях на консоль
